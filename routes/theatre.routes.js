...
const routes=(app)=>{
  ...
  //create theatre
    ...
    app.patch("/mba/api/v1/theatres/:id/movies",
      authMiddleware.isAuthenticated,authMiddleware.isAdminOrClient,theatreMiddleware.validateUpdateMovies,theatreController.updateMovies)
    app.put(
      "/mba/api/v1/theatres/:id",
      authMiddleware.isAuthenticated,
      authMiddleware.isAdminOrClient,theatreController.updateTheatre,
    );
     app.patch("/mba/api/v1/theatres/:id", authMiddleware.isAuthenticated,
           authMiddleware.isAdminOrClient, theatreController.updateTheatre);
